...
namespace GoodTimeStudio.MyPhone
{
    ...
    {
        // vm
        public SetPageViewModel ViewModel;
        ...
        public SetPage()
        {
            ...
            ViewModel = new SetPageViewModel();
        ...
        // Button_Click_GetRfcommServices
        ...
        }//Button_Click_GetRfcommServices end
        */

    }//SetPage class end

}//GoodTimeStudio.MyPhone namespace end
